...
public class EmailService {
    ...
    private String getStatusColor(Appointment.AppointmentStatus status) {
        return switch (status) {
            ...
            case ACCEPT -> "linear-gradient(135deg, #3b82f6 0%%, #2563eb 100%%)";
            case CONFIRMED -> "linear-gradient(135deg, #8b5cf6 0%%, #7c3aed 100%%)";
            case IN_PROGRESS -> "linear-gradient(135deg, #06b6d4 0%%, #0891b2 100%%)";
            case ONGOING -> "linear-gradient(135deg, #14b8a6 0%%, #0d9488 100%%)";
